...
Report bugs at https://github.com/romnn/favico/issues.
...
The best way to send feedback is to `file an issue <https://github.com/romnn/favico/issues>`_ on GitHub.
...
Ready to contribute? Here's how to set up favico for local development.

1. Fork the `favico repo <https://github.com/romnn/favico>`_ on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/favico.git
...
2. The pull request should work for python 3.5+. Check the
   `build status of your pull request <https://github.com/romnn/favico/actions>`_
...
.. _GitHub issues: https://github.com/romnn/favico/issues
